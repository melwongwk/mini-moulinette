...
int test1(void) {
    ...
    result_pos = 0;
    btree_apply_infix(root, &collector);
...
int test2(void) {
    ...
    btree_apply_infix(root, &collector);
    result_str[result_pos] = '\0';
    int pass = strcmp(result_str, "BAC") == 0;
    free_tree(root);
    if (!pass) {
        printf("    " RED "[2] Two-level infix failed\n" DEFAULT);
        return -1;
    }
    printf("  " GREEN CHECKMARK GREY " [2] Two-level infix passed\n" DEFAULT);
    return 0;
}
...
int test3(void) {
    ...
    free_tree(root);
    if (!pass) {
        printf("    " RED "[3] Left-heavy infix failed\n" DEFAULT);
        return -1;
    }
    printf("  " GREEN CHECKMARK GREY " [3] Left-heavy infix passed\n" DEFAULT);
    return 0;
}
...
int test4(void) {
    ...
    btree_apply_infix(root, &collector);
    result_str[result_pos] = '\0';
    int pass = strcmp(result_str, "ABC") == 0;
    free_tree(root);
    if (!pass) {
        printf("    " RED "[4] Right-heavy infix failed\n" DEFAULT);
        return -1;
    }
    printf("  " GREEN CHECKMARK GREY " [4] Right-heavy infix passed\n" DEFAULT);
    return 0;
}
...
int test5(void) {
    ...
    result_pos = 0;
    btree_apply_infix(r, &collector);
    result_str[result_pos] = '\0';
    int pass = strcmp(result_str, "DBEAFCG") == 0;
    free_tree(r);
    if (!pass) {
        printf("    " RED "[5] Full binary tree infix failed\n" DEFAULT);
        return -1;
    }
    printf("  " GREEN CHECKMARK GREY " [5] Full binary tree infix passed\n" DEFAULT);
    return 0;
}
...
int test6(void) {
    result_pos = 0;
    btree_apply_infix(NULL, &collector);
    result_str[result_pos] = '\0';
...
int test8(void) {
    ...
    free_tree(r);
    if (!pass) {
        printf("    " RED "[8] Unbalanced left tree failed\n" DEFAULT);
        return -1;
    }
    printf("  " GREEN CHECKMARK GREY " [8] Unbalanced left tree passed\n" DEFAULT);
    return 0;
}
...
int test9(void) {
    ...
    btree_apply_infix(r, &collector);
    result_str[result_pos] = '\0';
    int pass = strcmp(result_str, "ABCD") == 0;
    free_tree(r);
    if (!pass) {
        printf("    " RED "[9] Unbalanced right tree failed\n" DEFAULT);
        return -1;
    }
    printf("  " GREEN CHECKMARK GREY " [9] Unbalanced right tree passed\n" DEFAULT);
    return 0;
}
...
int test10(void) {
    ...
    btree_apply_infix(r, &collector);
    result_str[result_pos] = '\0';
    int pass = strcmp(result_str, "LNMQRS") == 0;
    free_tree(r);
    if (!pass) {
        printf("    " RED "[10] Mixed tree failed\n" DEFAULT);
        return -1;
    }
    printf("  " GREEN CHECKMARK GREY " [10] Mixed tree passed\n" DEFAULT);
    return 0;
}
